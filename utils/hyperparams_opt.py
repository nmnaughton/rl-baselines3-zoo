...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    n_steps = trial.suggest_categorical("n_steps", [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192])
    ...
    n_epochs = trial.suggest_categorical("n_epochs", [1, 5, 10, 20, 40, 80, 120, 160])
    gae_lambda = trial.suggest_categorical("gae_lambda", [0.5, 0.6, 0.7, 0.8, 0.9, 0.92, 0.95, 0.98, 0.99, 1.0])
